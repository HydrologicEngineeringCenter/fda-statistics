...
namespace Statistics.Validation
{
    public static class Resources
    {
        ...
        internal static string NonFiniteRangeNotice(IDistribution distribution) => $"The {distribution.Print()} generated the invalid range of values. This is because its parameterization results in infinite or non-numerical extreme values, this usually occurs when one or more parameters measuring dispersion are large or the central tendency of the distribution is approaching the minimum or maximum of the range: [{double.MinValue.ToString("E3")}, {double.MaxValue.ToString("E3")}] of finite values.";
